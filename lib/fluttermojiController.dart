...
class FluttermojiController extends GetxController {
  ...
  String filePath = '/storage/emulated/0/fluttermoji.png';
  ...
  Future<String> saveImage() async {
    try {
      ...
      if (_fluttermoji != null) {
        List<int> bytes = utf8.encode(_fluttermoji);
        final directory = await getApplicationDocumentsDirectory();
        String filePath = '${directory.path}/fluttermoji_image.png';
  ...
  String getFluttermojiFromOptions() {
    ...
    String _facialhair = FacialHair.generateFacialHair(
        facialHairType: _getFluttermojiProperty('facialHairType'), fhColor: _getFluttermojiProperty('facialHairColor'))!;
      ...
      case 'facialHairType':
        ...
        return '''<svg width="20px" height="20px" viewBox="0 -40 112 180" >''' +
            FacialHair.generateFacialHair(
                facialHairType: FacialHairType[attributeValueIndex!], fhColor: FacialHairColor[selectedOptions['facialHairColor']])! +
            '''</svg>''';
